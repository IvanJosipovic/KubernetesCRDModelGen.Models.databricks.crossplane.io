...
public partial class V1alpha1MwsPrivateAccessSettingsList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1MwsPrivateAccessSettings>
{
    ...
    /// <summary>List of V1alpha1MwsPrivateAccessSettings objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1MwsPrivateAccessSettings> Items { get; set; }
}
...
public partial class V1alpha1MwsPrivateAccessSettingsSpecProviderConfigRefPolicy
{
    ...
    public V1alpha1MwsPrivateAccessSettingsSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1alpha1MwsPrivateAccessSettingsSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1MwsPrivateAccessSettingsSpec
{
    ...
    public V1alpha1MwsPrivateAccessSettingsSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1alpha1MwsPrivateAccessSettingsSpecForProvider ForProvider { get; set; }
    ...
    public IList<V1alpha1MwsPrivateAccessSettingsSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
...
public partial class V1alpha1MwsPrivateAccessSettings : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1MwsPrivateAccessSettingsSpec>, IStatus<V1alpha1MwsPrivateAccessSettingsStatus?>
{
    ...
    public required V1alpha1MwsPrivateAccessSettingsSpec Spec { get; set; }

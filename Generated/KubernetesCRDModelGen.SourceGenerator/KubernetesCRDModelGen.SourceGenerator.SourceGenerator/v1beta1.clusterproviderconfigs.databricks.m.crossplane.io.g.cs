...
namespace KubernetesCRDModelGen.Models.databricks.m.crossplane.io;
/// <summary>A ClusterProviderConfig configures the Databricks provider.</summary>
...
public partial class V1beta1ClusterProviderConfigList : IKubernetesObject<V1ListMeta>, IItems<V1beta1ClusterProviderConfig>
{
    ...
    public const string KubeGroup = "databricks.m.crossplane.io";
    ...
    public string ApiVersion { get; set; } = "databricks.m.crossplane.io/v1beta1";
...
public partial class V1beta1ClusterProviderConfigSpec
{
    ...
    public required V1beta1ClusterProviderConfigSpecCredentials Credentials { get; set; }

...
namespace KubernetesCRDModelGen.Models.databases.databricks.m.crossplane.io;
/// <summary>
...
public partial class V1alpha1DatabaseInstanceList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1DatabaseInstance>
{
    ...
    public const string KubeGroup = "databases.databricks.m.crossplane.io";
    public const string KubePluralName = "databaseinstances";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    public string ApiVersion { get; set; } = "databases.databricks.m.crossplane.io/v1alpha1";

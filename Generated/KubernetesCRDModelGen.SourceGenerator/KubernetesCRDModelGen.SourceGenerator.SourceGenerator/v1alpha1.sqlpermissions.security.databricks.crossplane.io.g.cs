...
public partial class V1alpha1SQLPermissionsList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1SQLPermissions>
{
    ...
    /// <summary>List of V1alpha1SQLPermissions objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1SQLPermissions> Items { get; set; }
}
...
public partial class V1alpha1SQLPermissionsSpecForProviderClusterIdRefPolicy
{
    ...
    public V1alpha1SQLPermissionsSpecForProviderClusterIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1alpha1SQLPermissionsSpecForProviderClusterIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1SQLPermissionsSpecForProviderClusterIdRef
{
    ...
    public V1alpha1SQLPermissionsSpecForProviderClusterIdRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1SQLPermissionsSpecForProviderClusterIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1SQLPermissionsSpecForProviderClusterIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1SQLPermissionsSpecForProviderClusterIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1SQLPermissionsSpecForProvider
{
    ...
    public V1alpha1SQLPermissionsSpecForProviderClusterIdRef? ClusterIdRef { get; set; }

    /// <summary>Selector for a Cluster in compute to populate clusterId.</summary>
    [JsonPropertyName("clusterIdSelector")]
    public V1alpha1SQLPermissionsSpecForProviderClusterIdSelector? ClusterIdSelector { get; set; }
...
public partial class V1alpha1SQLPermissionsSpecInitProviderClusterIdRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1SQLPermissionsSpecInitProviderClusterIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1SQLPermissionsSpecInitProviderClusterIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1SQLPermissionsSpecInitProviderClusterIdRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1SQLPermissionsSpecInitProviderClusterIdRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1SQLPermissionsSpecInitProviderClusterIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1SQLPermissionsSpecInitProviderClusterIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1SQLPermissionsSpecInitProviderClusterIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1SQLPermissionsSpecInitProvider
{
    ...
    /// <summary>Reference to a Cluster in compute to populate clusterId.</summary>
    [JsonPropertyName("clusterIdRef")]
    public V1alpha1SQLPermissionsSpecInitProviderClusterIdRef? ClusterIdRef { get; set; }

    /// <summary>Selector for a Cluster in compute to populate clusterId.</summary>
    [JsonPropertyName("clusterIdSelector")]
    public V1alpha1SQLPermissionsSpecInitProviderClusterIdSelector? ClusterIdSelector { get; set; }
...
public partial class V1alpha1SQLPermissionsSpecProviderConfigRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1SQLPermissionsSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1SQLPermissionsSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1SQLPermissionsSpec
{
    ...
    public V1alpha1SQLPermissionsSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1alpha1SQLPermissionsSpecForProvider ForProvider { get; set; }
    ...
    public V1alpha1SQLPermissionsSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1alpha1SQLPermissionsSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1alpha1SQLPermissionsSpecProviderConfigRef? ProviderConfigRef { get; set; }
...
public partial class V1alpha1SQLPermissionsStatus
{
    ...
    public V1alpha1SQLPermissionsStatusAtProvider? AtProvider { get; set; }
...
[global::System.Obsolete("This API version is deprecated. Please migrate to v1beta1.")]
[KubernetesEntity(Group = KubeGroup, Kind = KubeKind, ApiVersion = KubeApiVersion, PluralName = KubePluralName)]
public partial class V1alpha1SQLPermissions : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1SQLPermissionsSpec>, IStatus<V1alpha1SQLPermissionsStatus?>
{
    public const string KubeApiVersion = "v1alpha1";
    ...
    public required V1alpha1SQLPermissionsSpec Spec { get; set; }

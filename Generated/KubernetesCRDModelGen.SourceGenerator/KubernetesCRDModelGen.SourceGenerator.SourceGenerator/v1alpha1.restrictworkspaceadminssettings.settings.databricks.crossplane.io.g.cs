...
public partial class V1alpha1RestrictWorkspaceAdminsSettingList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1RestrictWorkspaceAdminsSetting>
{
    ...
    /// <summary>List of V1alpha1RestrictWorkspaceAdminsSetting objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1RestrictWorkspaceAdminsSetting> Items { get; set; }
}
...
public partial class V1alpha1RestrictWorkspaceAdminsSettingSpecForProvider
{
    ...
    public IList<V1alpha1RestrictWorkspaceAdminsSettingSpecForProviderProviderConfig>? ProviderConfig { get; set; }

    /// <summary>The configuration details.</summary>
    [JsonPropertyName("restrictWorkspaceAdmins")]
    public IList<V1alpha1RestrictWorkspaceAdminsSettingSpecForProviderRestrictWorkspaceAdmins>? RestrictWorkspaceAdmins { get; set; }
...
public partial class V1alpha1RestrictWorkspaceAdminsSettingSpecInitProvider
{
    ...
    /// <summary>Configure the provider for management through account provider. This block consists of the following fields:</summary>
    [JsonPropertyName("providerConfig")]
    public IList<V1alpha1RestrictWorkspaceAdminsSettingSpecInitProviderProviderConfig>? ProviderConfig { get; set; }

    /// <summary>The configuration details.</summary>
    [JsonPropertyName("restrictWorkspaceAdmins")]
    public IList<V1alpha1RestrictWorkspaceAdminsSettingSpecInitProviderRestrictWorkspaceAdmins>? RestrictWorkspaceAdmins { get; set; }
...
public partial class V1alpha1RestrictWorkspaceAdminsSettingSpecProviderConfigRefPolicy
{
    ...
    public V1alpha1RestrictWorkspaceAdminsSettingSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1alpha1RestrictWorkspaceAdminsSettingSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1RestrictWorkspaceAdminsSettingSpec
{
    ...
    public V1alpha1RestrictWorkspaceAdminsSettingSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1alpha1RestrictWorkspaceAdminsSettingSpecForProvider ForProvider { get; set; }
    ...
    public V1alpha1RestrictWorkspaceAdminsSettingSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1alpha1RestrictWorkspaceAdminsSettingSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1alpha1RestrictWorkspaceAdminsSettingSpecProviderConfigRef? ProviderConfigRef { get; set; }
...
public partial class V1alpha1RestrictWorkspaceAdminsSettingStatusAtProvider
{
    ...
    /// <summary>Configure the provider for management through account provider. This block consists of the following fields:</summary>
    [JsonPropertyName("providerConfig")]
    public IList<V1alpha1RestrictWorkspaceAdminsSettingStatusAtProviderProviderConfig>? ProviderConfig { get; set; }

    /// <summary>The configuration details.</summary>
    [JsonPropertyName("restrictWorkspaceAdmins")]
    public IList<V1alpha1RestrictWorkspaceAdminsSettingStatusAtProviderRestrictWorkspaceAdmins>? RestrictWorkspaceAdmins { get; set; }
...
public partial class V1alpha1RestrictWorkspaceAdminsSettingStatus
{
    ...
    public V1alpha1RestrictWorkspaceAdminsSettingStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1alpha1RestrictWorkspaceAdminsSettingStatusConditions>? Conditions { get; set; }
...
[global::System.Obsolete("This API version is deprecated. Please migrate to v1beta1.")]
[KubernetesEntity(Group = KubeGroup, Kind = KubeKind, ApiVersion = KubeApiVersion, PluralName = KubePluralName)]
public partial class V1alpha1RestrictWorkspaceAdminsSetting : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1RestrictWorkspaceAdminsSettingSpec>, IStatus<V1alpha1RestrictWorkspaceAdminsSettingStatus?>
{
    public const string KubeApiVersion = "v1alpha1";
    ...
    public required V1alpha1RestrictWorkspaceAdminsSettingSpec Spec { get; set; }
